...
>[!TIP]
>to interact with multiple buttons, you should either use `es.MultiBlock.ModBlock.send()` or `es.SetConnectionOutput()` , which is equivalent to using the "place" button.
