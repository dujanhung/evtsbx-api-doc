...
>[!TIP]
>to interact with multiple buttons, you should use another MOD block whose script use `es.MultiBlock.ModBlock.send()` , which is equivalent to using the "place" button.
