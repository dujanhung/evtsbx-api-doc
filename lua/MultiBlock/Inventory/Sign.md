...
>[!CAUTION]
>this block is <i>very</i> dangerous, because it could store malicious script, malicious link, OOM bomb, bad ASCII arts and bad words. so, don't read it from untrusted sources.
