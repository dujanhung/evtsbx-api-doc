...
>[!TIP]
>to get player's up direction, use this one together with `es.Player.Position` . however, it would become incorrect if player was in the seat and enable orbit mode.