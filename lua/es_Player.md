...
>[!IMPORTANT]
>"Evertech Sandbox" API don't support any methods that could change player skin, change player inventory slot, force player to enter or exit the seat, toggle jetpack.
