...
>[!CAUTION]
>in old versions, don't detach the group of 3 of this block at a same time, because it would cause crash. this crash also works in multiplayer, and always target to the host. players gave this crash the term "three-coils bomb" .
